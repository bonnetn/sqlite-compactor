...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Compact specified tables from a SQLite database into parquet files."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "tables", nargs="+", type=str, help="List of table names to compact."
    )
    parser.add_argument(
        "--min_rows_to_compact",
        type=_positive_int,

# Base builder:
FROM debian:12-slim@sha256:f528891ab1aa484bf7233dbcc84f3c806c3e427571d75510a9d74bb5ec535b33 AS build
RUN apt-get update && \
...
# Run python code:
FROM gcr.io/distroless/python3-debian12:latest@sha256:76d63f150ff54abe8cd93762f09ef846013d8bbe42890b2832dadda1c80202a8

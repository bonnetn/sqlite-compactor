# Base builder:
FROM debian:12-slim@sha256:a629e796d77a7b2ff82186ed15d01a493801c020eed5ce6adaa2704356f15a1c AS build
RUN apt-get update && \
...
# Run python code:
FROM gcr.io/distroless/python3-debian12:latest@sha256:13dc9c80ae977a1f94221d0de31c68f6e5ae67bb52ba608ed476521b75a70f06

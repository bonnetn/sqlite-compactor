# Base builder:
FROM debian:12-slim@sha256:155280b00ee0133250f7159b567a07d7cd03b1645714c3a7458b2287b0ca83cb AS build
RUN apt-get update && \
...
# Run python code:
FROM gcr.io/distroless/python3-debian12:latest@sha256:fdc27dd2618ed24b0bff701274ef0ab9e3dcf4a7d6f21b056f0d925475b448ca

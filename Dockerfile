# Base builder:
FROM debian:12-slim@sha256:12c396bd585df7ec21d5679bb6a83d4878bc4415ce926c9e5ea6426d23c60bdc AS build
RUN apt-get update && \
...
# Run python code:
FROM gcr.io/distroless/python3-debian12:latest@sha256:d9fd857eb4a7639c5de33a65582aebe0339bd4e15e2551de27a1d95f73aa0a82

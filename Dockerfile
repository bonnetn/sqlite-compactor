# Base builder:
FROM debian:13-slim@sha256:8d7a3dca57e62717b0f10897aca189da5d7acde3cc1ced657bdfd06ef5379576 AS build
RUN apt-get update && \
...
# Run python code:
FROM gcr.io/distroless/python3-debian13:latest@sha256:0e300647f5a9d51fb686e9167c97248e0419cd6e5186efc50b642748aab8d8be

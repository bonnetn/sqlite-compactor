# Base builder:
FROM debian:12-slim@sha256:1537a6a1cbc4b4fd401da800ee9480207e7dc1f23560c21259f681db56768f63 AS build
RUN apt-get update && \
...
# Run python code:
FROM gcr.io/distroless/python3-debian12:latest@sha256:8e432c787b5c0697dfbfd783120351d90fd5f23ba9fff29532bbdbb87bc13160

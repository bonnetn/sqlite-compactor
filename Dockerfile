# Base builder:
FROM debian:12-slim@sha256:b1211f6d19afd012477bd34fdcabb6b663d680e0f4b0537da6e6b0fd057a3ec3 AS build
RUN apt-get update && \
...
# Run python code:
FROM gcr.io/distroless/python3-debian12:latest@sha256:224c734ca6de7cef2350e82ff9e01b4b56ce22ca3cbef3936018bfb171a7c6de
